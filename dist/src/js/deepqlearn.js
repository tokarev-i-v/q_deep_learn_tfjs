...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/deepqlearn.js":[function(require,module,exports) {
...
var Brain = function (num_states, num_actions, opt) {
  var opt = opt || {}; // in number of time steps, of temporal memory
  ...
  this.value_net.makeLayers(layer_defs); // and finally we need a Temporal Difference Learning trainer!
  ...
  this.tdtrainer = new convnetjs.SGDTrainer(this.value_net, tdtrainer_options); // experience replay
...
},{}]},{},["src/js/deepqlearn.js"], "window")
//# sourceMappingURL=/deepqlearn.map