...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/convnet.js":[function(require,module,exports) {
...
(function (global) {
  ...
  var InputLayer = function (opt) {
    var opt = opt || {}; // required: depth

    this.out_depth = getopt(opt, ['out_depth', 'depth'], 0); // optional: default these dimensions to 1

    this.out_sx = getopt(opt, ['out_sx', 'sx', 'width'], 1);
    this.out_sy = getopt(opt, ['out_sy', 'sy', 'height'], 1); // computed
...
(function (global) {
  ...
  var assert = global.assert; // Net manages a set of layers
  ...
  Net.prototype = {
    ...
    makeLayers: function (defs) {
      ...
      assert(defs[0].type === 'input', 'Error! First layer must be the input layer, to declare size of inputs'); // desugar layer_defs for adding activation, dropout layers etc
...
},{}]},{},["src/js/convnet.js"], "window")
//# sourceMappingURL=/convnet.map