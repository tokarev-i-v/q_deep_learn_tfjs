...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/src/js/adapter.min.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*! adapterjs - v0.14.1-6d236da - 2017-02-28 */
var AdapterJS = AdapterJS || {};
AdapterJS.options = AdapterJS.options || {}, AdapterJS.VERSION = "0.14.1-6d236da", AdapterJS.onwebrtcready = AdapterJS.onwebrtcready || function (isUsingPlugin) {}, AdapterJS._onwebrtcreadies = [], AdapterJS.webRTCReady = function (baseCallback) {
  if ("function" != typeof baseCallback) throw new Error("Callback provided is not a function");

  var callback = function () {
    "function" == typeof window.require && "function" == typeof AdapterJS.defineMediaSourcePolyfill && AdapterJS.defineMediaSourcePolyfill(), baseCallback(null !== AdapterJS.WebRTCPlugin.plugin);
  };
  ...
  if ("complete" === document.readyState) AdapterJS.WebRTCPlugin.pluginState = AdapterJS.WebRTCPlugin.PLUGIN_STATES.READY, AdapterJS.maybeThroughWebRTCReady();else var timer = setInterval(function () {
  ...
  var hasMatch = null;
  if (window.opr && opr.addons || window.opera || navigator.userAgent.indexOf(" OPR/") >= 0) hasMatch = navigator.userAgent.match(/OPR\/(\d+)/i) || [], webrtcDetectedBrowser = "opera", webrtcDetectedVersion = parseInt(hasMatch[1] || "0", 10), webrtcMinimumVersion = 26, webrtcDetectedType = "webkit", webrtcDetectedDCSupport = "SCTP";else if (navigator.userAgent.match(/Bowser\/[0-9.]*/g)) {
  ...
  if ("function" == typeof callback) {
    ...
    if (!isLocalFirefox) for (var prop in constraints.mandatory) constraints.mandatory.hasOwnProperty(prop) && prop.indexOf("Moz") !== -1 && delete constraints.mandatory[prop];
  ...
  if (isIE) {
    ...
    for (var pluginArray = navigator.mimeTypes, i = 0; i < pluginArray.length; i++) if (pluginArray[i].type.indexOf(plugType) >= 0) return void installedCb();
    ...
    getUserMedia = function (constraints, successCallback, failureCallback) {
      ...
      if (element && element.parentNode) {
        ...
        if ("object" !== nodeName) {
          ...
          for (var children = element.children, i = 0; i !== children.length; ++i) if ("streamId" === children[i].name) {
      ...
      for (var stream = null, children = from.children, i = 0; i !== children.length; ++i) if ("streamId" === children[i].name) {
      ...
      for (var prop in properties) if (prop) {
  ...
  return function e(t, n, r) {
    ...
    2: [function (requirecopy, module, exports) {
      ...
      !function () {
        var logging = requirecopy("./utils").log,
            browserDetails = requirecopy("./utils").browserDetails;
        module.exports.browserDetails = browserDetails, module.exports.extractVersion = requirecopy("./utils").extractVersion, module.exports.disableLog = requirecopy("./utils").disableLog;
    ...
    3: [function (requirecopy, module, exports) {
      ...
      var logging = requirecopy("../utils.js").log,
          browserDetails = requirecopy("../utils.js").browserDetails,
          chromeShim = {
      ...
      var SDPUtils = requirecopy("sdp"),
        ...
        shimPeerConnection: function () {
          window.RTCIceGatherer && (window.RTCIceCandidate || (window.RTCIceCandidate = function (args) {
              ...
              for (var i = 0; i < remoteCapabilities.codecs.length; i++) {
                ...
                if (lCodec.name.toLowerCase() === rCodec.name.toLowerCase() && lCodec.clockRate === rCodec.clockRate && lCodec.numChannels === rCodec.numChannels) {
                  commonCapabilities.codecs.push(rCodec), rCodec.rtcpFeedback = rCodec.rtcpFeedback.filter(function (fb) {
                    for (var j = 0; j < lCodec.rtcpFeedback.length; j++) if (lCodec.rtcpFeedback[j].type === fb.type && lCodec.rtcpFeedback[j].parameter === fb.parameter) return !0;
            ...
            }), this.transceivers = this._pendingOffer, delete this._pendingOffer);else if ("answer" === description.type) {
            ...
            if (null === candidate) this.transceivers.forEach(function (transceiver) {
              ...
              if (candidate.sdpMid) for (var i = 0; i < this.transceivers.length; i++) if (this.transceivers[i].mid === candidate.sdpMid) {
                mLineIndex = i;
                break;
              }
    ...
    10: [function (requirecopy, module, exports) {
      ...
      var logDisabled_ = !0,
        ...
        detectBrowser: function () {
          ...
          if (navigator.mozGetUserMedia) result.browser = "firefox", result.version = this.extractVersion(navigator.userAgent, /Firefox\/([0-9]+)\./, 1);else if (navigator.webkitGetUserMedia) {
  ...
  if (0 === urlParts[0].indexOf("stun")) iceServer = {
    urls: [url]
  };else if (0 === urlParts[0].indexOf("turn")) if (webrtcDetectedVersion < 27) {
...
}, AdapterJS.attachMediaStream = attachMediaStream, AdapterJS.reattachMediaStream = reattachMediaStream, AdapterJS.getUserMedia = getUserMedia, "undefined" == typeof Promise && (requestUserMedia = null), AdapterJS.maybeThroughWebRTCReady()), "undefined" != typeof exports && (module.exports = AdapterJS);
},{}]},{},["src/src/js/adapter.min.js"], "window")
//# sourceMappingURL=/adapter.min.map