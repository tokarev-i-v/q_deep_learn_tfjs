  ...
  class Eye{
    constructor(angle){
      ...
      this._view.geometry.computeBoundingBox();
      this._angle = angle; // angle relative to agent its on
      this._max_range = 85;
      this._sensed_proximity = 85; // what the eye is seeing. will be set in world.tick()
      this._sensed_type = -1; // what does the eye see?
    }
    get angle(){
      return this._angle;
    }
    ...
    get sensed_proximity(){
      return this._sensed_proximity;
    }
    get view(){
      return this._view;
    }
